<div class="px-4 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-10 2xl:px-10">
    <div class="mb-4 flex-col items-center gap-5 sm:flex-row md:flex md:justify-between lg:mr-4">
        ...
        @if (Auth::user()->isSuperadmin)
            <x-button wire:click="showCreating" title="{{ __('Add Admin') }}" aria-label="{{ __('Add Admin') }}" class="h-10 w-10 justify-center !px-0 !py-0">
            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-xl p-4 border border-gray-100 dark:border-gray-700">
                <div class="flex items-start gap-4 mb-4">
                    <div class="shrink-0" {{ $wireClick }}>
                        ...
                        @else
                            <div
                                class="h-12 w-12 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-gray-500">
                    ...
                    <div class="flex-1 min-w-0" {{ $wireClick }}>
                        ...
                        <span
                            class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300 mt-1">
                            {{ $user->group }}
                        </span>
                    </div>
                </div>
            ...
            <form wire:submit="create">
                ...
                <div class="mt-4 flex flex-col gap-4 sm:flex-row sm:gap-3">
                    <div class="w-full">
                        ...
                        <x-input id="create_password" class="mt-1 block w-full" type="password"
                ...
                <div class="mt-4 flex flex-col gap-4 sm:flex-row sm:gap-3">
                    ...
                    <div class="w-full">
                        ...
                        <x-input id="create_address" class="mt-1 block w-full" type="text"
                ...
                <div class="mt-4">
                    ...
                    <x-tom-select id="create_division" wire:model="form.division_id"
                ...
                <div class="mt-4">
                    ...
                    <x-tom-select id="create_jobTitle" wire:model="form.job_title_id"
            ...
            <form wire:submit.prevent="update" id="user-edit">
                ...
                <div class="mt-4 flex flex-col gap-4 sm:flex-row sm:gap-3">
                    <div class="w-full">
                        ...
                        <x-input id="edit_password" class="mt-1 block w-full" type="password"
                ...
                <div class="mt-4 flex flex-col gap-4 sm:flex-row sm:gap-3">
                    ...
                    <div class="w-full">
                        ...
                        <x-input id="edit_address" class="mt-1 block w-full" type="text"
                            wire:model="form.address" placeholder="Jl. Jend. Sudirman" autocomplete="off" />
                        @error('form.address')
                            <x-input-error for="form.address" class="mt-2" message="{{ $message }}" />
                        @enderror
                ...
                <div class="mt-4">
                    ...
                    <x-tom-select id="edit_division" wire:model="form.division_id"
                        placeholder="{{ __('Select Division') }}" :options="App\Models\Division::all()->map(fn($d) => ['id' => $d->id, 'name' => $d->name])" />
                    @error('form.division_id')
                        <x-input-error for="form.division_id" class="mt-2" message="{{ $message }}" />
                    @enderror
                ...
                <div class="mt-4">
                    ...
                    <x-tom-select id="edit_jobTitle" wire:model="form.job_title_id"
                        placeholder="{{ __('Select Job Title') }}" :options="App\Models\JobTitle::all()->map(fn($j) => ['id' => $j->id, 'name' => $j->name])" />
                    @error('form.job_title_id')
                        <x-input-error for="form.job_title_id" class="mt-2" message="{{ $message }}" />
                    @enderror
