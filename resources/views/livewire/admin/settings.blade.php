    ...
    <div class="mb-6 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div class="flex items-start gap-3">
                <div
                    class="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-2xl {{ $isSuperadmin ? 'bg-emerald-50 text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-300' : 'bg-amber-50 text-amber-600 dark:bg-amber-900/30 dark:text-amber-300' }}">
                    @if ($isSuperadmin)
                ...
                <div>
                    <div class="flex flex-wrap items-center gap-2">
                        <h3 class="text-sm font-semibold text-gray-900 dark:text-white">
                            {{ $isSuperadmin ? __('Changes save automatically') : __('Read-only mode') }}
                        </h3>
                    </div>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        {{ $isSuperadmin ? __('Updates are applied as soon as you change a value.') : __('You can review settings here, but only Superadmin can change values.') }}
                    </p>
                </div>
            </div>

            <div class="w-full lg:max-w-sm">
                <label for="settings-search"
                    class="mb-1.5 block text-xs font-semibold uppercase tracking-[0.2em] text-gray-500 dark:text-gray-400">
                    {{ __('Search settings') }}
                </label>
                <div class="relative">
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">
                                    {{ __('Configure compliance and preferences for') }} {{ $group }}</p>
                            </div>
