...
class PayrollManager extends Component
{
    ...
    public function mount()
    {
        if (\App\Helpers\Editions::payrollLocked()) {
            session()->flash('show-feature-lock', [
                ...
                'message' => 'Payroll Management is an Enterprise Feature 🔒. Please Upgrade.',
            ]);
    ...
    public function generate(PayrollServiceInterface $service)
    {
        ...
        if ($locked) {
            $this->dispatch('close-modal', 'generate-payroll-modal');
            ...
            $this->dispatch(
                'feature-lock',
                title: 'Payroll Locked',
                message: 'Payroll Generation is an Enterprise Feature 🔒. Please Upgrade.'
            );
    ...
    public function bulkPublish()
    {
        ...
        $this->dispatch('banner-message', [
            'style' => 'success',
            'message' => 'Selected payrolls published.',
        ]);
    }
    ...
    public function bulkPay()
    {
        ...
        $payrolls = Payroll::whereIn('id', $this->selectedPayrolls)
